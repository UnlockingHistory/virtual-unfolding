...
export default function run(
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_raw`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_gaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_dGaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_ddGaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_gaussYgaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_gaussYdGaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_dGaussYgaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_dGaussYdGaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_gaussYddGaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_ddGaussYgaussZ`, gpuHelper);
    ...
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_clipped`, gpuHelper);
    ...
    // Convolve Gz with derivs of y.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_gaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
    ...
    // Convolve dGz with derivs of y.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_dGaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
    ...
    // Convolve ddGz with derivs of y.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_ddGaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
    ...
    // Convolve GzGy with derivs of x.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_gaussYgaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
    ...
    // Convolve dGzGy with derivs of x.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_gaussYdGaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
    ...
    // Convolve GzdGy with derivs of x.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_dGaussYgaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
    ...
    // Convolve dGzdGy with derivs of x.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_dGaussYdGaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
    ...
    // Convolve ddGzGy with derivs of x.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_gaussYddGaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
    ...
    // Convolve GzddGy with derivs of x.
    convolution1D.setInput(fileParams.OUTPUT_PATH, `${fileParams.FILENAME}_ddGaussYgaussZ_${NORMAL_RELAX_GAUSS_SCALE}X`, gpuHelper);
